...
<div class="container">
    <main class="form-signin w-100 m-auto">
        <form action="" method="post">
            <img  class="mb-4" src="./img/loto.png" alt="aplication" width="100">
            <h4 class="text-secondary">My Aplicación</h4>
            ...
            <p class="mt-3 mb-3 text-muted">Todos los Derechos Reservados | Lottus
                &copy; <%=displayDate()%>
            </p>
